...
const createStyles = (dimensions: ScaledSize): Styles =>
  StyleSheet.create({
    container: {
      flex: 1,
...
export default function MeetScreen() {
  ...
  const swipeCard = (direction: "left" | "right") => {
    const x =
      direction === "right" ? dimensions.width + 100 : -dimensions.width - 100;
  ...
  return (
    <ThemedView style={styles.container}>
        ...
        >
          ...
          >
            <View style={styles.cardInfo}>
              ...
              <Text style={styles.cardDetails}>
                Available:{" "}
                {formatAvailability(profiles[currentIndex + 1].availability)}
              </Text>
            </View>
          </LinearGradient>
        </Animated.View>
      ...
      <Animated.View
        ...
        style={[styles.card, rotateAndTranslate as any]}
      >
        ...
        <Animated.View
          style={[styles.dislikeBadge, { opacity: dislikeOpacity }]}
        >
        ...
        >
          <View style={styles.cardInfo}>
            ...
            <Text style={styles.cardDetails}>
              Available:{" "}
              {formatAvailability(profiles[currentIndex].availability)}
            </Text>
          </View>
        </LinearGradient>
      </Animated.View>
